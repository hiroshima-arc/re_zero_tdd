# fizzbuzz serverless API
The fizzbuzz project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=fizzbuzz -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot2-archetype -DarchetypeVersion=1.3.1 -DgroupId=org.hiroshima_arc -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd fizzbuzz
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "FizzbuzzApi",
                    "OutputKey": "FizzbuzzApi",
