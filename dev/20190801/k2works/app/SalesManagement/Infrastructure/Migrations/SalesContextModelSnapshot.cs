...
namespace SalesManagement.Infrastructure.Migrations
{
    ...
    class SalesContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.AlternateProducts", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.AutoNumber", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.BankAcutMst", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.Bom", b =>
                {
                    b.Property<string>("ProdCode")
                        .HasColumnName("PROD_CODE")
                        .HasMaxLength(16);
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.CategoryType", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.CompanyCategory", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.CompanyCategoryGroup", b =>
                {
                    b.Property<string>("CategoryType")
                        .HasColumnName("CATEGORY_TYPE")
                        .HasMaxLength(2);
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.CompanyGroupMst", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.CompanysMst", b =>
                {
                    b.Property<string>("CompCode")
                        .HasColumnName("COMP_CODE")
                        .HasMaxLength(8);
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.Credit", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.CreditBalance", b =>
                {
                    b.Property<string>("CompCode")
                        .HasColumnName("COMP_CODE")
                        .HasMaxLength(8);
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.CustomersMst", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.PoDetails", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.Pricebycustomer", b =>
                {
                    b.Property<string>("ProdCode")
                        .HasColumnName("PROD_CODE")
                        .HasMaxLength(16);
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.ProductCategory", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.Products", b =>
                {
                    b.Property<string>("ProdCode")
                        .HasColumnName("PROD_CODE")
                        .HasMaxLength(16);
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.Pu", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.PuDetails", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.PurchaseOrders", b =>
                {
                    b.Property<string>("PoNo")
                        .HasColumnName("PO_NO")
                        .HasMaxLength(10);
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.Sales", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.SalesDetails", b =>
                {
                    b.Property<string>("SalesNo")
                        .HasColumnName("SALES_NO")
                        .HasMaxLength(10);
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.Stock", b =>
                {
                    b.Property<string>("WhCode")
                        .HasColumnName("WH_CODE")
                        .HasMaxLength(3);
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.SupplierMst", b =>
                {
                    b.Property<string>("SupCode")
                        .HasColumnName("SUP_CODE")
                        .HasMaxLength(8);
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.WhDeptMst", b =>
                {
                    b.Property<string>("WhCode")
                        .HasColumnName("WH_CODE")
                        .HasMaxLength(3);
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.WhMst", b =>
                {
                    b.Property<string>("WhCode")
                        .HasColumnName("WH_CODE")
                        .HasMaxLength(3);
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.Bom", b =>
                {
                    b.HasOne("SalesManagement.Domain.Models.Products", "ProdCodeNavigation")
                        .WithOne("Bom")
                        .HasForeignKey("SalesManagement.Domain.Models.Bom", "ProdCode")
                        .HasConstraintName("FK_PRODUCTS_BOM");
                });

            modelBuilder.Entity("SalesManagement.Domain.Models.CompanyCategory", b =>
                {
                    b.HasOne("SalesManagement.Domain.Models.CategoryType", "CategoryTypeNavigation")
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.CompanyCategoryGroup", b =>
                {
                    b.HasOne("SalesManagement.Domain.Models.CompanyCategory", "C")
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.CreditBalance", b =>
                {
                    b.HasOne("SalesManagement.Domain.Models.CompanysMst", "CompCodeNavigation")
                        .WithOne("CreditBalance")
                        .HasForeignKey("SalesManagement.Domain.Models.CreditBalance", "CompCode")
                        .HasConstraintName("FK_COMPANYS_MST_CREDIT_BALANC");
                });

            modelBuilder.Entity("SalesManagement.Domain.Models.CustomersMst", b =>
                {
                    b.HasOne("SalesManagement.Domain.Models.CompanysMst", "CustCodeNavigation")
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.PoDetails", b =>
                {
                    b.HasOne("SalesManagement.Domain.Models.PurchaseOrders", "PoNoNavigation")
                        .WithMany("PoDetails")
                        .HasForeignKey("PoNo")
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.PuDetails", b =>
                {
                    ...
                    b.HasOne("SalesManagement.Domain.Models.Pu", "PuNoNavigation")
                        .WithMany("PuDetails")
                        .HasForeignKey("PuNo")
                        .HasConstraintName("FK_PU_PU_DETAILS");

                    b.HasOne("SalesManagement.Domain.Models.WhMst", "WhCodeNavigation")
                        .WithMany("PuDetails")
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.SalesDetails", b =>
                {
                    b.HasOne("SalesManagement.Domain.Models.Sales", "SalesNoNavigation")
            ...
            modelBuilder.Entity("SalesManagement.Domain.Models.SupplierMst", b =>
                {
                    b.HasOne("SalesManagement.Domain.Models.CompanysMst", "SupCodeNavigation")
            ...
            modelBuilder.Entity("SalesManagement.Models.Orders", b =>
                {
                    ...
                    b.HasOne("SalesManagement.Domain.Models.CustomersMst", "Cust")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("SalesManagement.Models.Pay", b =>
                {
                    ...
                    b.HasOne("SalesManagement.Domain.Models.SupplierMst", "Sup")
                        .WithMany("Pay")
