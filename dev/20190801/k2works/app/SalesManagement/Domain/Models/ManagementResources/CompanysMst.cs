...
{
    public sealed class CompanysMst
    {
        public CompanysMst()
        {
        ...
        public ICollection<CustomersMst> CustomersMst { get; set; }
        public ICollection<Pricebycustomer> Pricebycustomer { get; set; }
        public ICollection<SupplierMst> SupplierMst { get; set; }
    }
}
