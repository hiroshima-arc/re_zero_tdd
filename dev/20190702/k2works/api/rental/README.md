# rental serverless API
The rental project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=rental -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot2-archetype -DarchetypeVersion=1.3.2 -DgroupId=rental -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd rental
$ mvn clean package
